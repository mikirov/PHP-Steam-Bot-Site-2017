...
$code = $totp->now();
$url2 = "https://bitskins.com/api/v1/get_all_item_prices/?api_key=46704883-70ef-411b-96df-94f0384a9bf3&code=".$code."&app_id=730";
...
<div class="container text-center" id="contents">
	<div>
		<h1 style="color:white;margin: 0 40px">Withdraw items</h1>
		<button type="button" class="btn btn-info" id="deposit" onclick="deposit();">Withdraw Selected</button>
	</div>
